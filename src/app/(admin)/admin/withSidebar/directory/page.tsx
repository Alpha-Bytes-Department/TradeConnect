                    ...
                    <div className="flex flex-col lg:flex-row gap-4 mb-6">
                        ...
                        <div className="flex-1 relative">
                            ...
                            <input
                                ...
                                className="truncate w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            />
                        </div>
