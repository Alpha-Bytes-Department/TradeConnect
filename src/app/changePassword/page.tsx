                            ...
                            <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-6">
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="relative">
                                        ...
                                        {getPasswordValidationError(newPassword) && <p className="p-2 px-4 font-semibold text-red-700">{getPasswordValidationError(newPassword)}</p>}
                                ...
                                <div className=" md:w-[70%] flex flex-col md:flex-row gap-4">
                                    <button
                                        type="submit"
                                        disabled={isSubmitting || (getPasswordValidationError(newPassword) && getPasswordValidationError(newPassword) ? true : false)}
