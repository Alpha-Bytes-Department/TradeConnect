...
export default function NavBarWithTrigger() {
    ...
    const [userPhoto, setUserPhoto] = useState<string | null>(null); // Changed to null initially
    ...
    useEffect(() => {
        ...
        setUserPhoto(localStorage.getItem('user_photo') || null); // Set to null if empty
